...
TRANSLATIONS = {
    ...
    'fr': {
        ...
        'about_text': "Nous sommes une agence de traduction composée de notre propre équipe de traducteurs et interprètes assermentés, certifiés et de langue maternelle, dirigée par Fatima Benamar Bahamad. Forte de plus de 25 ans d'expérience, notre agence propose des services de traduction aux particuliers, aux entreprises et aux institutions publiques et privées.<br><br>Nous offrons à nos clients un service rapide et personnalisé, le respect des délais, une qualité irréprochable, la confidentialité, des conseils d'experts, une communication directe et des tarifs compétitifs.<br><br>Nous nous engageons à satisfaire pleinement nos clients et à livrer les travaux dans les délais convenus.",
        'about_cat_1': "TRADUCTION - INTERPRÉTATION",
        'about_langs': "Arabe, Espagnol, Anglais et Français",
        'about_name': "Fátima Benamar Bahamad",
        'about_role': "Directeur general",
        'about_company': "Tigafab,S.L.",
