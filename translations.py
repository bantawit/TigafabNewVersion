...
TRANSLATIONS = {
    ...
    'ar': {
        ...
        'reviews_data': [
            ...
            ("مجموعة البناء (Google)", "لقد كنا نثق في تيجافاب لسنوات لمعالجة التأشيرات والترجمة التقنية للغة العربية لملفات شركتنا. سريعون وفعالون."),
            ...
            ("فرانسيسكو ت. (Google)", "لقد قدمت لنا تيجافاب المشورة من فوينلابرادا لافتتاح فرع في شمال إفريقيا. الجودة الإنسانية لفريقهم لا تصدق."),
