...
TRANSLATIONS = {
    ...
    'fr': {
        ...
        'srv_jurada_list': [
            "Passeports vers l'Arabe", "Actes", "Contrats", "Pouvoirs", "Statuts de sociétés",
            ...
            "Factures commerciales", "Certificats sanitaires et phytosanitaires", "Accords sociaux",
        ...
        'srv_tecnica_list': [
            "Présentations", "Catalogues", "Plans d'affaires", "Manuels", "Pages Web",
            "Listes de prix", "Correspondances", "Lettres", "Notes", "Rapports", "Et tout autre document"
        ],
        'srv_organismos_title': "Gestion de Documents auprès des Organismes Officiels",
        'srv_organismos_list': [
            ...
            "Collège des notaires de Madrid", "Toutes les ambassades et consulats (Libye, Algérie, Iran, Égypte, Chine, ...)",
    ...
    'de': {
        ...
        'reviews_data': [
            ("Marta", "Exzellenter und professioneller Service. Pünktlich."),
