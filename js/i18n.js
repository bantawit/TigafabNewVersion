window.translations = {
  ...
  de: {
    ...
    home_text_1: "Wir sind ein Büro von offiziellen, beeidigten Übersetzern unter der Leitung von Frau Fatima Benamar mit über 25 Jahren Erfahrung. Wir bieten schnellen, persönlichen Service in höchster Qualität. WIR BIETEN umfassenden Service bei beglaubigten Übersetzungen an.",
  ...
  ar: {
    ...
    home_text_1: "نحن مكتب للمترجمين المحلفين والمحترفين بإدارة السيدة فاطمة بنعمر بخبرة تزيد عن 25 عاماً. نقدم خدمات سريعة و مخصصة بأقصى جودة وسرية تامة. نحن نقدم خدمة شاملة في الترجمة المحلفة لضمان تنفيذ أعمالك بشكل صحيح. سيوفر لك ذلك الوقت والمال والمتاعب.",
