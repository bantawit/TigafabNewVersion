// Script para generar web multi-página clásica
const fs = require('fs');
const path = require('path');

const dir = '/Users/mohamedbentaoit/Downloads/ProyectosAnti-gravity/tigafab-web-nueva';
...
const footer = `
  ...
  <footer>
    ...
    <p class="t-footer-rights">© 2026 TIGAFAB S.L. Todos los derechos reservados.</p>
  </footer>
...
const getTemplate = (title, content, headAdd='') => `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
for (const [filename, content] of Object.entries(pages)) {
  const finalContent = getTemplate(filename.replace('.html','').toUpperCase(), content);
  fs.writeFileSync(path.join(dir, filename), finalContent, 'utf8');
}
console.log('Se generaron todas las paginas multi-page!');
