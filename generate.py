...
pages = {
  ...
  <section style="padding: 6rem 2rem; background: var(--bg-dark); color:#fff; overflow:hidden;">
    <div class="container">
      <div style="text-align:center; margin-bottom:4rem;">
        <h2 class="t-reviews-title" style="font-size:2.5rem; font-family:var(--font-heading); color:#fff;">Lo que dicen nuestros clientes</h2>
        <div style="width: 50px; height: 2px; background: var(--primary); margin: 1rem auto;"></div>
        <p style="color:rgba(255,255,255,0.7);"><i class="fab fa-google"></i> Reseñas verificadas de Google Maps</p>
      </div>
      
      <div class="marquee-wrapper" style="position: relative; width: 100%; padding: 20px 0;">
        <div class="marquee-content" style="display: flex; gap: 2rem; animation: marquee 40s linear infinite;">
          <!-- Las reseñas se pueden añadir aquí o por JS. Dejo estructura fija de muestra -->
          <div class="review-card" style="min-width: 350px; background: rgba(255,255,255,0.05); padding: 2rem; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);">
            ...
            <p style="font-style: italic; color: #cbd5e1; margin-bottom: 1.5rem;">"Excelente servicio de traducción jurada. Muy rápidos y profesionales. Totalmente recomendados."</p>
            <div style="font-weight: 600; color: #fff;">Juan Pérez</div>
          </div>
          <div class="review-card" style="min-width: 350px; background: rgba(255,255,255,0.05); padding: 2rem; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);">
            <div style="color: #FFD700; margin-bottom: 1rem;"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
            <p style="font-style: italic; color: #cbd5e1; margin-bottom: 1.5rem;">"Great experience with technical translations. High quality and attention to detail."</p>
            <div style="font-weight: 600; color: #fff;">Sarah Miller</div>
          </div>
          <div class="review-card" style="min-width: 350px; background: rgba(255,255,255,0.05); padding: 2rem; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);">
            <div style="color: #FFD700; margin-bottom: 1rem;"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
            <p style="font-style: italic; color: #cbd5e1; margin-bottom: 1.5rem;">"Servicio impecable en la gestión de mi visado. Me ahorraron mucho tiempo y complicaciones."</p>
            <div style="font-weight: 600; color: #fff;">Marta García</div>
          </div>
        </div>
      </div>
    </div>
