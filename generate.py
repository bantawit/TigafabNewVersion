...
for lang in LANG_FOLDERS:
    ...
    <div class="contact-form-premium" data-aos="fade-left"><form action="https://formsubmit.co/bantawitesp@gmail.com" method="POST" enctype="multipart/form-data"><input type="hidden" name="_subject" value="Nuevo contacto desde web TIGAFAB"><input type="hidden" name="_captcha" value="false"><input type="hidden" name="_next" value="http://127.0.0.1:63914/gracias.html"><div class="form-group-premium"><input type="text" name="name" placeholder="{t['form_name']}" required></div><div class="form-group-premium"><input type="email" name="email" placeholder="{t['form_email']}" required></div><div class="form-group-premium"><input type="tel" name="phone" placeholder="{t['form_phone']}"></div><div class="form-group-premium"><textarea rows="5" name="message" placeholder="{t['form_message']}" required></textarea></div><div class="form-group-premium"><label style="display:block; margin-bottom:0.5rem; color:var(--text-soft); font-size:0.9rem;">{t['form_file']}</label><div class="file-upload-wrapper"><input type="file" name="attachment" id="fileInput" style="display:none;"><label for="fileInput" class="file-upload-label"><i class="fas fa-cloud-upload-alt"></i><span class="file-upload-text">t-form-file-text</span></label><span class="file-name-display" id="fileName"></span></div></div><button type="submit" class="btn-premium" style="width:100%">t-form-btn</button></form></div>
    </div></div></section>"""
