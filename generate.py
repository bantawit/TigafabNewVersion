...
def get_nav(lang, rel_path):
    ...
    return f"""<nav id="navbar" dir="ltr"><div class="container nav-container"><a href="{rel_path}index.html" class="logo">TIGAFAB<span>.</span></a><ul class="nav-links"><li><a href="{rel_path}index.html">{t['nav_home']}</a></li><li><a href="{rel_path}quienes-somos.html">{t['nav_about']}</a></li><li><a href="{rel_path}clientes.html">{t['nav_clients']}</a></li><li><a href="{rel_path}servicios.html">{t['nav_services']}</a></li><li><a href="{rel_path}contacto.html">{t['nav_contact']}</a></li></ul><div class="lang-selector" id="langSelector"><div class="lang-current">{t['nav_lang']} <i class="fas fa-chevron-down"></i></div><div class="lang-dropdown" id="langDropdown">{links}</div></div></div></nav>"""
