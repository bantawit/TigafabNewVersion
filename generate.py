...
for lang in LANG_FOLDERS:
    ...
    <div class="service-premium-box" data-aos="fade-up" data-aos-delay="200"><i class="fas fa-landmark"></i><h3>t-srv-organismos-title</h3><p class="service-desc">t-srv-organismos_desc</p><ul class="service-list-detailed">{get_list_html('srv_organismos_list', lang)}</ul></div>
    <div class="service-premium-box" data-aos="fade-up" data-aos-delay="250"><i class="fas fa-certificate"></i><h3>t-srv-legalizacion-title</h3><p class="service-desc">t-srv-legalizacion_desc</p></div>
