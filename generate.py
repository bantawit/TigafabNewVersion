...
# --- TRADUCCIONES MAESTRAS (CON LISTAS COMPLETAS) ---
TRANSLATIONS = {
    'es': {
        ...
        # SERVICIOS (LISTAS GIGANTES RESTAURADAS)
        ...
        'srv_organismos_list': ["Ministerio de Asuntos Exteriores", "Ministerio de Justicia", "Ministerio de Sanidad y Agricultura", "Cámara de Comercio de Madrid", "Colegio de Notarios de Madrid", "Embajadas (Libia, Argelia, Irán, Egipto, China...)"],
...
for lang in LANG_FOLDERS:
    ...
    # 2. SERVICIOS COMPLETOS (LISTA LARGA RESTAURADA)
    ...
    <div class="contact-info-box" data-aos="fade-right"><h2>t-contact-title</h2><div class="contact-item"><i class="fas fa-map-marker-alt"></i><div><h4>Ubicación</h4><p>C/ Constitución, Fuenlabrada, Madrid</p></div></div><div class="contact-item"><i class="fas fa-envelope"></i><div><h4>Email</h4><p>info@tigafab.com</p></div></div><div class="contact-item"><i class="fas fa-phone-alt"></i><div><h4>Teléfono</h4><p>+34 91 606 20 20</p></div></div></div>
...
print("✅ ÉXITO: Servicios GIGANTES restaurados al 100% y blindados.")
