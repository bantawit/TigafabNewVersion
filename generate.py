...
<head>
  ...
  <style>
    ...
    .marquee-container {{ cursor: grab; overflow: hidden; display: flex; position: relative; }}
    .marquee-container:active {{ cursor: grabbing; }}
    .marquee-container:hover .marquee-inner {{ animation-play-state: paused !important; }}
    [dir="rtl"] .marquee-inner {{ animation: marquee-rtl 35s linear infinite !important; }}
